...
$HTMLHeaderFmt['galleria'] = '<link rel="stylesheet" type="text/css" href="'. $PubDirUrl. '/galleria/galleria.css" />
<link rel="stylesheet" type="text/css" href="'. $PubDirUrl. '/galleria/jquery.jcarousel.css" />
<link rel="stylesheet" type="text/css" href="'. $PubDirUrl. '/galleria/tango/skin.css" />
...
function galleria ($args) {
	$o = Array(
		...
		'visible'			=> '4',			// the width/height of the items will be calculated and set depending on the width/height of the clipping, so that exactly that number of items will be visible.
	...
	return '<script type="text/javascript">
		...
		function mycarousel_initCallback(carousel) {
			$("'. $o['image']. '").bind("img_change",function() {
