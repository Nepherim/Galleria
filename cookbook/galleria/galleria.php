...
$HTMLHeaderFmt['galleria'] = '<script src="'. $PubDirUrl. '/galleria/galleria-1.2.3.js"></script>'.
	'<script type="text/javascript">Galleria.loadTheme("'. $PubDirUrl. '/galleria/themes/classic/galleria.classic.min.js");</script>';
